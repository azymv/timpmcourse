...
export function PricingCard({ name, price, period, features, featured }: PricingCardProps) {
  ...
  return (
    <>
      <div className="relative p-6 bg-black rounded-lg border border-zinc-800">
        {featured && (
        ...
        <div className="space-y-6">
          ...
          <Button className="w-full bg-white text-black hover:bg-gray-100" onClick={() => setShowPaymentModal(true)}>
